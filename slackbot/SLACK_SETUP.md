...
5. Select **YAML** tab
6. Copy and paste the contents of `manifests/slack/kagent.yaml`
...
- `users:read` - View user profiles (needed for Phase 3 RBAC)
- `users:read.email` - View user emails (needed for Phase 3 RBAC)
...
- Configure RBAC with Slack user groups (Phase 3)
