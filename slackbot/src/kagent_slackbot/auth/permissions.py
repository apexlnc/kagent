...
class PermissionChecker:
    """Check agent access permissions using FilterByUser pattern"""
    ...
    async def can_access_agent(
        ...
        """
        Check if user can access agent (FilterByUser pattern from breakglass-bot)
    ...
    async def filter_agents_by_user(
        ...
        """
        Filter agent list to only show accessible agents (FilterByUser pattern)
